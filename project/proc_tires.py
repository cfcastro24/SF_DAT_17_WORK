...
tires_2011 = pd.read_csv('~/charlie_dev/SF_DAT_17_WORK/project/data/processed_tires_2011.csv')
#killings = pd.read_csv('data/police-killings.csv')
#basic profiling
# examine the data
tires_2011                  # print the first 30 and last 30 rows
tires_2011.head()           # print the first 5 rows
tires_2011.tail()           # print the last 5 rows
tires_2011.describe()       # describe any numeric columns
tires_2011.info()           # concise summary
tires_2011.columns          # get series of column names
tires_2011.shape            # tuple of (#rows, #cols)
